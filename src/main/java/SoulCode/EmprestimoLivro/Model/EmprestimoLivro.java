package SoulCode.EmprestimoLivro.Model;
...
public class EmprestimoLivro {
    ...
    public EmprestimoLivro(String id, String nomeDaReserva, LocalDate dataSaida, LocalDate dataDevolucao, String nomeLivro) {
        this.id = id;
